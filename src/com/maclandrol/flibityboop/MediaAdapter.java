...
public class MediaAdapter extends BaseAdapter{
	...
	public Object getItem(int position) {
		return _data!=null&&position>=0 &&position<this.getCount()?_data.get(position):null;
	}
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if(media.getPoster()!=null)
			poster.setImageBitmap(media.getPoster());

		
		if(position % 2 == 0)
			view.setBackgroundColor(_context.getResources().getColor(R.color.alt_back));
		else
			view.setBackgroundColor(_context.getResources().getColor(R.color.back));
